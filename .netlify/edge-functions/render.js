  ...
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    Contatti = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return ` ${validate_component(Section, "Section").$$render(
        ...
        {
          default: () => {
            return `<div class="flex flex-rows justify-between text-nowrap text-sm gap-10 " data-svelte-h="svelte-1p21xic"><p>ig: <br>
      mail: <br>
      LinkedIn: <br>
      ...
      info@qdesign.it <br> <a href="https://www.linkedin.com/company/q-studios-padova/" class="underline underline-offset-2">Q Design Studios</a><br>
    ...
    Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="flex flex-wrap lg:flex-nowrap w-full gap-5 mb-10 mt-48"><div class="flex-auto w-full lg:max-w-[20vw]">${validate_component(Contatti, "Contatti").$$render($$result, {}, {}, {})}</div> <div class="flex-auto w-full lg:max-w-[22vw]">${validate_component(Section, "Section").$$render($$result, { title: ["LEGAL", "\u2193 LEGAL", "\u2198 LEGAL"] }, {}, {
        default: () => {
          return `<p class="col-span-4 text-xs font-normal row-span-2 content-end" data-svelte-h="svelte-jf7rvd">Q Design Studio by VIRGO S.r.l.
        <br>
    ...
    NavbarHandler = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css2);
      $$unsubscribe_page();
      return `<div><meta name="theme-color" content="#f5f5f5">  ${!isMobile ? `${validate_component(NavDesktop, "NavDesktop").$$render($$result, {}, {}, {})}` : ``} ${isMobile ? `  <div class="${escape(
        isOpen ? " hide hidden collapse " : " visible show block ",
        true
      ) + " svelte-10efjfe"}"><div class="w-full flex justify-start fixed top-0 left-0 p-5 gap-2.5"><a href="/" class="svelte-10efjfe" data-svelte-h="svelte-1vxwdnl"><img src="/assets/logo/logo_partial.svg" alt="" class="h-[32px]"></a> <div class="flex w-full"></div> <button data-svelte-h="svelte-88ujgd"><svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 2H22M0 10H22M0 18H22" stroke="black" stroke-width="4"></path></svg></button></div></div>  <div class="${escape(null_to_empty(isOpen ? " show block " : " hide "), true) + " svelte-10efjfe"}"><div class="fixed top-0 left-0 w-auto p-5 h-screen bg-primary "><nav class="grid grid-cols-4 grid-rows-12 gap-5 whitespace-nowrap "><div class="row-span-5 col-span-4 small-handling" data-svelte-h="svelte-c32ddl"><img src="/assets/logo/logo_partial_white.svg" alt="" srcset=""></div> <div class="col-span-4 w-full grid grid-cols-4 grid-rows-1 gap-2"><div class="w-full flex gap-5 col-span-4"><hr class="w-full svelte-10efjfe"> <button data-svelte-h="svelte-8z67k6"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.13153 22.0002L12.0459 12.0859M12.0459 12.0859L22.1315 2.00024M12.0459 12.0859L1.95996 2M12.0459 12.0859L21.96 22" stroke="#0A0A0A" stroke-width="4"></path></svg></button></div> <div class="col-span-2 content-end text-xl"><a class="text-neutral svelte-10efjfe" href="/">${$page.url.pathname === "/" ? `\u203A
                ` : ``}HOME</a></div> <div class="col-span-2 content-end text-xl ml-1.5"><a class="text-neutral svelte-10efjfe" href="/mission">${$page.url.pathname === "/mission" ? `\u203A
                ` : ``}MISSION</a></div></div> <div class="row-span-2 col-span-2 text-xl mt-10 " data-svelte-h="svelte-1jbrxvx"> </div> <div class="col-span-4 row-span-2 grid content-end" data-svelte-h="svelte-168pln0"><p class="text-xs font-normal w-full">Q Design Studio by VIRGO S.r.l.
              <br>
              Strada comunale delle Corti, 54n - 31100 TREVISO - TV
              <br>
              Tutti i servizi Q Design Studio sono forniti da VIRGO S.r.l.
              <br>
              P.IVA: 05543270267</p></div></nav></div></div>` : ``} </div>`;
    });
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.DrUqvkuK.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/chunks/Du05DkRF.js", "_app/immutable/chunks/DMntwZay.js", "_app/immutable/chunks/oItSYdui.js", "_app/immutable/chunks/Mcva588Y.js", "_app/immutable/chunks/B67tyITN.js"];
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.DgnSSaCC.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/chunks/Du05DkRF.js", "_app/immutable/chunks/Mcva588Y.js", "_app/immutable/chunks/B67tyITN.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
    ...
    cases = [
      {
        hero: {
          ...
          content: [
            "Q Design Studios \xE8 dove ci\xF2 che inizialmente non percepiamo prende forma.",
            "Definiamo idee e visioni che sono essenziali per vivere veramente."
          ],
          titleMobile: [
            "Design Studios",
            "Contact Us\u2193",
          ...
          contentMobile: [
            "Q Design Studios \xE8 dove ci\xF2 che inizialmente non percepiamo prende forma. Definiamo idee e visioni che sono essenziali per vivere veramente."
          ]
        },
        people: [
          {
...
var init_Scroll = __esm({
  ".svelte-kit/output/server/chunks/Scroll.js"() {
    init_ssr();
    css$12 = {
      code: ".text-auto-scale-mobile.svelte-mi4gfa{font-size:6vmin;font-size:9vmax;line-height:105%;transform:translateY(-5%)}@media(height > 800px){.text-auto-scale.svelte-mi4gfa{font-size:12vmin;font-size:17vmax;line-height:105%;transform:translateY(-5%)}}@media(height <= 800px){.text-auto-scale.svelte-mi4gfa{font-size:12vmin;font-size:13vmax;line-height:105%;transform:translateY(-5%)}}",
      map: '{"version":3,"file":"Hero.svelte","sources":["Hero.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { animateTyping } from \\"$lib/components/Typewriter\\";\\nexport let title;\\nexport let titleMobile;\\nexport let content;\\nexport let contentMobile;\\n<\/script>\\n\\n<!--hero-->\\n<div class=\\"h-svh w-max-content absolute\\">\\n  <!--mobile-->\\n  <h1\\n    class=\\"inline-block text-auto-scale-mobile lg:hidden mt-[4rem] lg:h-[55vh]\\"\\n  >\\n    <span use:animateTyping={titleMobile} />\\n  </h1>\\n\\n  <div class=\\"lg:hidden\\">\\n    <!--contentMobile-->\\n    {#each contentMobile as paragraph}\\n      <p class=\\"text-2xl\\">\\n        {paragraph}\\n      </p>\\n    {/each}\\n  </div>\\n\\n  <!--desktop-->\\n  <h1\\n    class=\\"hidden lg:block text-auto-scale lg:min-h-[55vh] overflow-hidden mt-3.5\\"\\n  >\\n    <span use:animateTyping={title} />\\n  </h1>\\n\\n  <!--content-->\\n  <div class=\\"hidden lg:block w-max -mt-10\\">\\n    {#each content as paragraph}\\n      <p class=\\"text-2xl\\">\\n        {paragraph}\\n      </p>\\n    {/each}\\n  </div>\\n\\n  <!-- <slot /> -->\\n</div>\\n\\n<style>\\n  \\n  .text-auto-scale-mobile {\\n    font-size: 6vmin;\\n    font-size: 9vmax;\\n    line-height: 105%;\\n    transform: translateY(-5%);\\n  }\\n  @media (height > 800px) {\\n    .text-auto-scale {\\n      font-size: 12vmin;\\n      font-size: 17vmax;\\n      line-height: 105%;\\n      transform: translateY(-5%);\\n    }\\n  }\\n  @media (height <= 800px) {\\n    .text-auto-scale {\\n      font-size: 12vmin;\\n      font-size: 13vmax;\\n      line-height: 105%;\\n      transform: translateY(-5%);\\n    }\\n  }\\n</style>\\n"],"names":[],"mappings":"AA8CE,qCAAwB,CACtB,SAAS,CAAE,KAAK,CAChB,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,WAAW,GAAG,CAC3B,CACA,MAAO,CAAC,MAAM,CAAC,CAAC,CAAC,KAAK,CAAE,CACtB,8BAAiB,CACf,SAAS,CAAE,MAAM,CACjB,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,WAAW,GAAG,CAC3B,CACF,CACA,MAAO,CAAC,MAAM,CAAC,EAAE,CAAC,KAAK,CAAE,CACvB,8BAAiB,CACf,SAAS,CAAE,MAAM,CACjB,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,WAAW,GAAG,CAC3B,CACF"}'
    };
    Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return ` <div class="h-svh w-max-content absolute"> <h1 class="inline-block text-auto-scale-mobile lg:hidden mt-[4rem] lg:h-[55vh] svelte-mi4gfa"><span></span></h1> <div class="lg:hidden"> ${each(contentMobile, (paragraph) => {
        return `<p class="text-2xl">${escape(paragraph)} </p>`;
      })}</div>  <h1 class="hidden lg:block text-auto-scale lg:min-h-[55vh] overflow-hidden mt-3.5 svelte-mi4gfa"><span></span></h1>  <div class="hidden lg:block w-max -mt-10">${each(content, (paragraph) => {
        return `<p class="text-2xl">${escape(paragraph)} </p>`;
      })}</div>  </div>`;
    });
    css3 = {
  ...
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="absolute bottom-16 w-[25vw]">${validate_component(Scroll, "Scroll").$$render($$result, {}, {}, {})}</div> <div class="mt-5 lg:mt-0 w-full">${validate_component(Hero, "Hero").$$render(
        ...
        {
          default: () => {
            return `<p data-svelte-h="svelte-1lprkpb">Abbiamo teste diverse, ognuna con personalit\xE0 e abilit\xE0 differenti ma
        siamo anche un insieme di persone che condividono non solo gli stessi
        obiettivi, ma anche la stessa attitudine. Qui la creativit\xE0 incontra il metodo, la strategia
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.CPpx2c4d.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/chunks/Du05DkRF.js", "_app/immutable/chunks/D1WQKXfQ.js", "_app/immutable/chunks/oItSYdui.js", "_app/immutable/chunks/DMntwZay.js", "_app/immutable/chunks/BVD3xV-H.js"];
    stylesheets3 = ["_app/immutable/assets/2.CAntiSs9.css", "_app/immutable/assets/Scroll.kBqFF_Ph.css", "_app/immutable/assets/Section.q3_R_wNJ.css"];
    fonts3 = [];
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.DpdRr-zS.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/chunks/Du05DkRF.js", "_app/immutable/chunks/BVD3xV-H.js", "_app/immutable/chunks/D1WQKXfQ.js", "_app/immutable/chunks/oItSYdui.js", "_app/immutable/chunks/DMntwZay.js", "_app/immutable/chunks/BoI-ajZI.js"];
    stylesheets4 = ["_app/immutable/assets/Scroll.kBqFF_Ph.css", "_app/immutable/assets/Section.q3_R_wNJ.css", "_app/immutable/assets/Quote.BNnoJQcK.css"];
    fonts4 = [];
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    imports6 = ["_app/immutable/nodes/5.WbJ6TVFh.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/chunks/Du05DkRF.js", "_app/immutable/chunks/BVD3xV-H.js", "_app/immutable/chunks/D1WQKXfQ.js", "_app/immutable/chunks/oItSYdui.js", "_app/immutable/chunks/DMntwZay.js", "_app/immutable/chunks/BoI-ajZI.js"];
    stylesheets6 = ["_app/immutable/assets/Scroll.kBqFF_Ph.css", "_app/immutable/assets/Section.q3_R_wNJ.css", "_app/immutable/assets/Quote.BNnoJQcK.css"];
    fonts6 = [];
  }
});
...
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    ...
    imports7 = ["_app/immutable/nodes/6.B49vnhcP.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/chunks/Du05DkRF.js", "_app/immutable/chunks/D1WQKXfQ.js", "_app/immutable/chunks/oItSYdui.js"];
    stylesheets7 = ["_app/immutable/assets/6.8QD4hOGa.css", "_app/immutable/assets/Scroll.kBqFF_Ph.css"];
    fonts7 = [];
  }
});
...
var options = {
  ...
  templates: {
    app: ({ head, body: body2, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n\n\n  <!-- Google tag (gtag.js) -->\n  <script\n    async\n    src="https://www.googletagmanager.com/gtag/js?id=AW-16755659389"\n  ><\/script>\n  <script>\n    window.dataLayer = window.dataLayer || [];\n    function gtag() {\n      dataLayer.push(arguments);\n    }\n    gtag("js", new Date());\n\n    gtag("config", "AW-16755659389");\n  <\/script>\n\n\n  <head>\n    <meta charset="utf-8" />\n    <link rel="icon" href="' + assets2 + '/favicon.png" />\n    <meta name="viewport" content="width=device-width, initial-scale=1" />\n    ' + head + '\n  </head>\n  <body data-sveltekit-preload-data="hover">\n    <div style="display: contents">' + body2 + "</div>\n  </body>\n</html>\n",
...
var manifest = (() => {
  ...
  return {
    ...
    _: {
      client: { start: "_app/immutable/entry/start.D81rwBkO.js", app: "_app/immutable/entry/app.B3mDIqbA.js", imports: ["_app/immutable/entry/start.D81rwBkO.js", "_app/immutable/chunks/B67tyITN.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/entry/app.B3mDIqbA.js", "_app/immutable/chunks/DSniZyfg.js", "_app/immutable/chunks/Du05DkRF.js"], stylesheets: [], fonts: [], uses_env_dynamic_public: false },
      nodes: [
